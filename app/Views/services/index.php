...
<header
    ...
    <div>
                <a href="<?= URL_CONTROLLER ?>/Service/viewCreate" class="btn btn-agregar">
                        ...
                        <div class="card">
                            <div class="card-body d-flex">
                                ...
                                <div class="service-image">
                                    <img src="<?= FOLDER_PUBLIC_ASSETS ?>/img/background/combo01.png"<?= htmlspecialchars($service['image'] ?? 'default.jpg') ?>"
                                         alt="<?= htmlspecialchars($service['name_service']) ?>"
                                         class="img-fluid"

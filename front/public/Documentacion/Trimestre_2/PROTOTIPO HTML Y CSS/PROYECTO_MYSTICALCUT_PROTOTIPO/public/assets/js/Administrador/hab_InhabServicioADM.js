function toggleConfirmation(event) {
    ...
    const message = isChecked 
        ? "¿Está seguro que desea habilitar este servicio?"
        : "¿Está seguro que desea inhabilitar este servicio?";
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            const successMessage = isChecked 
                ? 'Servicio habilitado con éxito.'
                : 'Servicio inhabilitado con éxito.';

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2025 a las 05:28:15
...
(7, 'maria.gomez@email.com', '$2b$10$DEopUjIRHwokIoH186keMuunuedwnbSyIg3Le3FGY3akfF0o.uwl.', 'María Gómez', '23456789', 1, 3, 2, 'Avenida Siempre Viva 456, Ciudad', '623056789', NULL, NULL, NULL),
...
(9, 'ana.martinez@email.com', '$2b$10$vjXnt9Pt29WM8XZ4IhzmsOWrr/yJfA.7Z39iGbbv/8cYmPHFD6JZm', 'Ana Martínez', '45678901', 1, 3, 2, 'Calle de la Luna 101, Ciudad', '645678901', NULL, NULL, NULL),
...
--
ALTER TABLE `quotes`
  MODIFY `id_quotes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

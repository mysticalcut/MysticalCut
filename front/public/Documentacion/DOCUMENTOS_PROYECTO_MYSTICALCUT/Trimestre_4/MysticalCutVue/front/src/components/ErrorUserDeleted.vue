<template>
    <div class="error-container">
      ...
      <p class="error-description">
        La cuenta a la que intentas acceder fue eliminada. No es posible ingresar al sistema en este momento.
      </p>
  ...
  .error-container {
    ...
    font-family: 'Amasis_MT_Std_Black'; /* Usa la fuente de otros componentes */
  }
